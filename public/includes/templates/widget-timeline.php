...
foreach($tweets as $tweet):
    ...
    <li class="of-tweet">
    	<div id="tweet-<?php echo $tweet_id; ?>" class="tweet-content">
        	<?php 
        	$text = preg_replace('#@(\w+)#', '<a target="_blank" href="http://twitter.com/$1">$0</a>', $tweet->text);
			$text = preg_replace('/#(\w+)/', '<a target="_blank" href="http://twitter.com/search?q=%23$1&src=hash">$0</a>', $text);
			echo $text; ?>
        </div>
